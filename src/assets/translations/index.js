const localizationData = {
  ua: {
    ...
    hero: {
      ...
      mainText: 'Експертна оцінка ',
      submainText: 'та консультації з нумізматики',
    ...
    contact: {
      title: 'Маєте питання або хочете скористатися нашими послугами?',
    },
  ...
  en: {
    ...
    form: {
      name: 'Ivan Prudko',
      summary:
        'Co-founder and expert of the company "Monitex" - the number one online store for collectors in Ukraine.',
